...
?>
<form name="form1" method="post" action="updatenews2.php">
  <table width="625" border="1" align="center">
    <tr>
      <td height="30" colspan="2" align="center" bgcolor="#CCCCCC">新闻信息编辑</td>
    </tr>
    <tr>
      ...
      <?php
			if($row[5]){
				 echo '<img src="'.$row[5].'" class="nrs_tu">'; 
			 	 echo  '<a href="updatenews3.php">修改缩略图 </a>'; 
			}else{
					echo  '<a href="updatenews3.php">无缩略图，可添加缩略图 </a>'; 
			}
